...
void tabladescore(int score, FILE *arch){
    ...
    //Guarda el puntuaje de la partida acabada en el archivo de texto
	fprintf(arch,"%d \n",score);
	fclose(arch);

}

void leersc(FILE *arch){
    char punts;

    arch = fopen("JGscore.txt","r");
